...
public class LoginAdmin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("==Connexion Administrateur==");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String userpassword = new String(jTextField1.getPassword());

        if (username.equals(adminUser) && userpassword.equals(adminPassword)) {
            //JOptionPane.showMessageDialog(LoginAdmin.this, "Connexion reussi");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                LoginAdmin popup = new LoginAdmin(parentFrame, true);
    ...
    private final String adminUser = "Nelson";
