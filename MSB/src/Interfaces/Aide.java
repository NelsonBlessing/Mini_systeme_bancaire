...
public class Aide extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Supprimer compte");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        // CHANGER PIN
        ChangerPIN popup = new ChangerPIN(new javax.swing.JFrame(), true, Session.getTelephone());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int confirmation = JOptionPane.showConfirmDialog(null, "Etes-vous sur de vouloir supprimer définitivement votre compte ?", "Confirmation",JOptionPane.YES_NO_OPTION);

        if (confirmation == JOptionPane.YES_NO_OPTION) {
            boolean success = motDpasse.supprimerCompte(idClient);

            if (success) {
                JOptionPane.showMessageDialog(null, "Compte supprimé avec succès");

                 Window window = SwingUtilities.getWindowAncestor(jButton3);
                ...
                JOptionPane.showMessageDialog(null, "Echec de la suppression du compte");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Aide popup = new Aide(parentFrame, true);
                popup.setLocationRelativeTo(null);
                popup.setVisible(true);
            }
        });
